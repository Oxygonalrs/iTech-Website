...
<body>
    ...
    <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow" style="background-color: #225470;">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="studentprofile.php">E-learning
        </a>
    </nav>
                ...
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item mb-3">
                            <img src="<?php if(isset($row['stu_img'])){echo $row['stu_img'];}else{echo './js.jpg';} ?>" 
                            alt="studentImage" class="img-thumbnail rounded-circle">                             
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="studentprofile.php"><!--<?php //if(PAGE == 'profile'){echo 'active';} ?>-->
