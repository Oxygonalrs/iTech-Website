            ...
            while($row = $result->fetch_assoc())
            {
                if(isset($_REQUEST['checkid']) && ($_REQUEST['checkid'] == $row['course_id']))
                {
                    ...
                    if(($row['course_id'])== $_REQUEST['checkid'])
                    {
                        ...
                        <span class="ml-5 text-center">Course Name: <?php if(isset($row['course_name'])){echo $row['course_name'];}?></span></h3>
                        <?php
                        ...
                        echo '<td>
                            <form method="POST" action="editlesson.php"class="d-inline">
